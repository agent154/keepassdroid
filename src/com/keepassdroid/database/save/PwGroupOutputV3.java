...
public class PwGroupOutputV3 {
	...
	public void output() throws IOException {
		// NOTE: Need be to careful about using ints. The actual type written to file is a unsigned int, but most values
		// can't be greater than 2^31, so it probably doesn't matter.
