...
public class PwEntryV3 extends PwEntry {
	...
	/**
	 * This date was was accidentally being written out when an entry was supposed to be marked as expired. We'll use this
	 * to silently correct those entries.
	 * 
	 * @return
	 */
	...
	/*
	 * public PwEntryV3(PwEntryV3 source) { assign(source); }
	 */
	...
	public boolean isMetaStream() {
		...
		if (additional == null || additional.length() == 0)
			return false;
		if (!binaryDesc.equals(PMS_ID_BINDESC))
			return false;
		if (title == null)
			return false;
		if (!title.equals(PMS_ID_TITLE))
			return false;
		if (username == null)
			return false;
		if (!username.equals(PMS_ID_USER))
			return false;
		if (url == null)
			return false;
		if (!url.equals(PMS_ID_URL))
			return false;
