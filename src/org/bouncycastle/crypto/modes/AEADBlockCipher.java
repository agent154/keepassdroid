...
public interface AEADBlockCipher {
	 ...
	 * @return the space required to accommodate a call to processBytes with len bytes of input.
	 */
	 ...
	 * @param len
	 *          the length of the input.
	 * @return the space required to accommodate a call to processBytes and doFinal with len bytes of input.
	 */
