...
public class Salsa20Engine implements StreamCipher {
	...
	private final static byte[]	sigma	= toByteArray("expand 32-byte k"), tau = toByteArray("expand 16-byte k");
	...
	private byte[]	keyStream		= new byte[stateSize * 4], // expanded state, 64 bytes
			workingKey = null, workingIV = null;
	...
	public void init(boolean forEncryption, CipherParameters params) {
		/*
		 * Salsa20 encryption and decryption is completely symmetrical, so the 'forEncryption' is irrelevant. (Like 90% of
		 * stream ciphers)
		 */
