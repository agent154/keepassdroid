...
/**
 * a general purpose ASN.1 decoder - note: this class differs from the others in that it returns null after it has read
 * the last object in the stream. If an ASN.1 NULL is encountered a DER/BER Null object is returned.
 */
public class ASN1InputStream extends FilterInputStream implements DERTags {
	...
	/**
	 * Create an ASN1InputStream based on the input byte array. The length of DER objects in the stream is automatically
	 * limited to the length of the input array.
	 * 
	 * @param input
	...
	/**
	 * Create an ASN1InputStream where no DER object will be longer than limit, and constructed objects such as sequences
